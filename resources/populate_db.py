...
class CsvConverter:
    ...
    def backupCsvFile(self):
        ...
        self.session = sessionHandler.get_subaccount_session()
        ...
        backupHandler.backup(self.session, region, csvData)
...
class S3InitialBackup:
    ...
    def backup(self, session, region, csvData):
...
dynamoDbWriter = DynamoDbWriter(csvConverter.session)
